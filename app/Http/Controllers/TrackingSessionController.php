    ...
    public function status(string $sessionToken): JsonResponse
    {
        ...
        return response()->json([
            ...
            'latest_telemetry' => $latestTelemetryPoint ? [
                ...
                'elapsed_time_seconds' => $latestTelemetryPoint->elapsed_time_seconds,
                'distance_m' => $latestTelemetryPoint->distance_m,
                'pace_sec_per_km' => $latestTelemetryPoint->pace_sec_per_km,
                'average_pace_sec_per_km' => $latestTelemetryPoint->average_pace_sec_per_km,
                'current_speed_mps' => $latestTelemetryPoint->current_speed_mps,
                ...
                'altitude_m' => $latestTelemetryPoint->altitude_m,
                'heading_degrees' => $latestTelemetryPoint->heading_degrees,
                'ascent_m' => $latestTelemetryPoint->ascent_m,
                'descent_m' => $latestTelemetryPoint->descent_m,
                'calories' => $latestTelemetryPoint->calories,
                'lap_number' => $latestTelemetryPoint->lap_number,
